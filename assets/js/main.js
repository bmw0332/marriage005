...
(function (w, d) {
  ...
  var FAQS = [
    ...
    { q: '結婚相談所への｜営業をされますか？',
      a: ['診断内容に応じて、｜継続支援を｜ご案内する｜場合があります。｜ただし、｜その場で入会を｜決める必要は｜ありません。｜現在のアプリや｜相談所を続ける方が｜よい場合は、｜そのまま｜お伝えします。'] },
    { q: '事前に準備するものは｜ありますか？',
    ...
    { q: '恋愛経験や交際経験が｜ほとんどなくても｜大丈夫ですか？',
      a: ['問題ありません。｜交際経験が少なく、｜会話や｜関係の深め方に｜悩んでいる男性を｜主な対象と｜しています。'] },
    { q: '原因を必ず｜特定できますか？',
      a: ['お相手本人の｜考えを断定することは｜できません。｜これまでの活動状況や｜実際のやり取りを｜もとに、｜止まっている｜可能性が高い場所と、｜次に検証する｜改善策を整理します。'] },
    { q: '33項目の評価まで｜無料で受けられますか？',
      a: ['無料個別診断では、｜現在の活動状況と｜改善の優先順位を｜整理します。｜模擬お見合いと｜全33項目の評価は、｜継続支援を｜ご利用いただく｜場合に実施します。'] },
    { q: '遠方からでも｜受けられますか？',
